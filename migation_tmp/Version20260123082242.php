 ...
 */
final class Version20260123082242 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE manekineko DROP auteur');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE manekineko ADD auteur VARCHAR(255) NOT NULL');
    }
}
