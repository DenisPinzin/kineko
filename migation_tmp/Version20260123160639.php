 ...
 */
final class Version20260123160639 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fabriquant CHANGE nom nom VARCHAR(50) NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CFF97A3A6C6E55B5 ON fabriquant (nom)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_CFF97A3A6C6E55B5 ON fabriquant');
        $this->addSql('ALTER TABLE fabriquant CHANGE nom nom VARCHAR(255) NOT NULL');
