 ...
 */
final class Version20260126091429 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire ADD CONSTRAINT FK_67F068BC46B51E5C FOREIGN KEY (manekineko_id) REFERENCES manekineko (id) ON DELETE CASCADE');
