 ...
 */
final class Version20260124151415 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE manekineko CHANGE description description LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE manekineko CHANGE description description LONGTEXT DEFAULT NULL');
    }
}
