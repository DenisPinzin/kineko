 ...
 */
final class Version20260123140234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE manekineko DROP nom_fabriquant');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE manekineko ADD nom_fabriquant VARCHAR(255) DEFAULT NULL');
